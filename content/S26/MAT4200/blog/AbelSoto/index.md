...
<img width="628" height="632" alt="Simplex" src="https://github.com/user-attachments/assets/2b15d0d7-9e25-4362-bb6b-c777a02d9a64" />


*Figure: The 2-simplex representing all probability distributions on three outcomes. Each point satisfies $(x+y+z=1)$, with $(x,y,z \ge 0)$*
...
cuts out a surface, and the inequalities keep us inside a bounded region.
...
At a point $p \in \Delta^k$, the tangent space consists of vectors $v$ such that
...
Starting with
$$
\Delta^k = \{(x_0,\dots,x_k) \mid x_i \ge 0,\ \sum_{i=0}^k x_i = 1\},
$$
...
- The actual simplex sitting inside $\mathbb{R}^{k+1}$ has volume  
  $$
  \frac{\sqrt{k+1}}{k!}
  $$
