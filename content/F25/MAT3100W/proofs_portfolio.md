...
<ol>
  ...
  <ul>
    ...
    <li>Numbers and number systems</li>
    <ul>
      <li>Parity, divisibility, and modular arithmetic</li>
      <li>Rational and irrational numbers (e.g. $\sqrt2$)</li>
      <li>Real numbers, absolute value, and inequalities</li>
      <li>Combinatorics: combinations, permutations, and factorials.</li>
      <li>Countable sets (e.g. $\mathbb Q$)</li>
      <li>Uncountable sets (e.g. $\mathbb{R}$)</li>
    </ul>
    <li>Relations and functions</li>
    <ul>
      <li>Relations and equivalence relations.</li>
      <li>Functions</li>
      <li>Injections (one-to-one), surjections (onto), and bijections</li>
    </ul>
  </ul>
  <li>Proof techniques</li>
  <ul>
    <li>Direct proofs</li>
    <li>Transformation of conditionals</li>
    <ul>
      <li>Inverse statements</li>
      <li>Converse statements</li>
      <li>Contrapositive proofs</li>
      <li>Bidirectional ("if and only if" proofs)</li>
    </ul>
    <li>Quantifiers</li>
    <ul>
  ...
  <ul>
    <li>Favorite ideas from the class</li>
    <li>Writing advice you'd give to your past self</li>
  </ul>
</ol>
...
- **How has your mathematical imagination been enhanced as a result of taking this class?** <br> *Give at least three examples.*
- **Consider one mathematical idea from the course that you have found beautiful, and explain why it is beautiful to you.**
- **For any problems you cannot solve on this exam, suggest a strategy you might try to tackle the problem, and show what happened as a result.** <br> *Describe any strategic gaps you were unable to bridge, and list 3 helpful insights that may help another person trying to tackle the problem.*

[^1]: Your portfolio (and almost all mathematical writing) is written *out of order*.
In this portfolio, you will start with sections 2 and 3, followed by section 4, followed by section 5, and finishing with section 1.
